...
CREATE POLICY IF NOT EXISTS "Acceso público a comunidades" ON comunidades FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Acceso público a miembros" ON miembros FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Acceso público a eventos" ON eventos FOR ALL USING (true);
CREATE POLICY IF NOT EXISTS "Acceso público a eventos_activos" ON eventos_activos FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY IF NOT EXISTS "Acceso público a eventos_activos_aportantes" ON eventos_activos_aportantes FOR ALL USING (true) WITH CHECK (true);
